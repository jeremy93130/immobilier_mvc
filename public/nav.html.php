    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (Service\Session::getUserConnected()) : ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= addLink("postulant", "show", $_SESSION['user']->getId()) ?>"><?= $_SESSION['user']->getPrenom() ?></a>
                    </li>
                    ...
                    <?php if (Service\Session::isadmin()) : ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="<?= addLink('admin/postulant', 'index') ?>">Liste</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= addLink('admin/postulant', 'new') ?>">Ajouter</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
